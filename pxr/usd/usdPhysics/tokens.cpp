...
UsdPhysicsTokensType::UsdPhysicsTokensType() :
    ...
    physicsLowerAxisLimit("physics:lowerAxisLimit", TfToken::Immortal),
    ...
    physicsUpperAxisLimit("physics:upperAxisLimit", TfToken::Immortal),
